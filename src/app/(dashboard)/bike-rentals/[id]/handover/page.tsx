...
export default function BikeHandoverPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await bikeRentalsService.handoverBooking(bookingId, payload);
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">Bike Handover</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-[#111111] p-6 rounded-xl border border-[#27272A]">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="col-span-2">
              <label className="block text-sm font-medium text-gray-400 mb-1.5">Bike Photos (Optional)</label>
