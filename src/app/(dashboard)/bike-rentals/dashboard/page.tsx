...
export default function RentalDashboardPage() {
  ...
  useEffect(() => {
    const fetchMetrics = async () => {
      try {
        const data = await bikeRentalsService.getDashboardMetrics();
    ...
    <div className="space-y-5 pb-12 animate-in fade-in duration-500">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <GlassCard>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-[10px] font-bold text-[#A1A1AA] uppercase tracking-wider">Total Bikes</p>
              <h3 className="mt-0.5 text-2xl font-black tracking-tighter text-white drop-shadow-lg">{metrics?.totalBikes || 0}</h3>
            </div>
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500/20 to-blue-600/5 shadow-[inset_0_1px_2px_rgba(59,130,246,0.3)] border border-blue-500/20">
              <Bike className="h-4 w-4 text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]" />
            </div>
          </div>
        </GlassCard>
        ...
        <GlassCard>
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="mt-0.5 text-2xl font-black tracking-tighter text-emerald-400 drop-shadow-lg">{metrics?.availableBikes || 0}</h3>
            </div>
        ...
        <GlassCard>
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="mt-0.5 text-2xl font-black tracking-tighter text-red-400 drop-shadow-lg">{(metrics?.totalBikes || 0) - (metrics?.availableBikes || 0)}</h3>
            </div>
        ...
        <GlassCard>
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="mt-0.5 text-2xl font-black tracking-tighter text-rose-500 drop-shadow-lg">{metrics?.overdueBikes || 0}</h3>
            </div>
      ...
      {/* Quick Services */}
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4">
        <Link href="/bike-rentals/new" className="group flex items-center gap-3 rounded-full bg-[#111111] border border-[#27272A] p-2 pr-5 transition-all duration-300 hover:bg-[#1A1A1A] hover:border-white/10 hover:-translate-y-0.5 hover:shadow-lg">
          ...
          <div className="flex flex-col justify-center">
            <h4 className="text-[13px] font-bold text-white leading-tight">Add Bike</h4>
            <p className="text-[10px] text-[#A1A1AA] leading-tight mt-0.5">Expand your fleet</p>
          </div>
        </Link>
        <Link href="/bike-rentals/fleet" className="group flex items-center gap-3 rounded-full bg-[#111111] border border-[#27272A] p-2 pr-5 transition-all duration-300 hover:bg-[#1A1A1A] hover:border-white/10 hover:-translate-y-0.5 hover:shadow-lg">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-[10px] text-[#A1A1AA] leading-tight mt-0.5">Edit bike details</p>
          </div>
        </Link>
        <Link href="/bike-rentals/bookings" className="group flex items-center gap-3 rounded-full bg-[#111111] border border-[#27272A] p-2 pr-5 transition-all duration-300 hover:bg-[#1A1A1A] hover:border-white/10 hover:-translate-y-0.5 hover:shadow-lg">
