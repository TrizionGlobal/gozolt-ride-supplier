...
export default function EditRentalBikePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-white">Edit Rental Bike</h1>
        <p className="text-sm text-[#A1A1AA]">Update the configuration of your rental bike.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="rounded-xl border border-[#27272A] bg-[#111111] p-6 space-y-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div>
              <label className="block text-sm font-medium text-[#A1A1AA] mb-1">Bike Name (Make & Model)</label>
              <input
                type="text"
                required
