...
export default function BikeRentalsHistoryPage() {
  const {
    historyBookings,
    historyTotal,
    historyPage,
  ...
  const columns: ColumnDef<any>[] = [
    ...
    },
    {
      ...
      render: (b) => (
        <div className="flex justify-center">
          <Link
            href={`/bike-rentals/${b.id}/details?source=history`}
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white">Bike Rentals History</h1>
